...
G4VPhysicalVolume *MyDetectorConstruction::Construct()
{
    ...
    // Load GDML file
    G4GDMLParser parser;
    parser.Read("../gdmlFiles/setup_curved.gdml");  // Replace with your GDML file name
    ...
    new G4PVPlacement(rotMatrixTarget, G4ThreeVector(0, 0, 0), logicTarget, "physTarget", logicWorld, false, 0, true);
